...
class _ItemswidgetsState extends State<Itemswidgets> {
  ...
  List<List<String>> dogItems = [
    ['33', 'Pedigree dog food 1kg', '100.000'],
    ['34', 'Royal Canin dog food 1kg', '150.000'],
    ['35', 'Hills Science dog food 1kg', '200.000'],
    ['36', 'Iams dog food 1kg', '180.000']
  ];

  List<List<String>> birdItems = [
    ['22', 'Bird food type A', '30.000'],
    ['23', 'Bird food type B', '25.000'],
    ['24', 'Bird food type C', '35.000'],
    ['25', 'Bird food type D', '40.000']
  ];
